...
void test_index_entry2(Lexicon* lexicon) {
    ...
    // int c = 0;
    // int d = 0;
    // cout << (index_entry[49].getWord() == "emily") << endl;
    // cout << index_entry[49].getChapterWordCounts()[0].first << endl;
    for (auto& entry : index_entry) {
        // c++;
...
void test_preorder(Lexicon* lexicon) {
    ...
    // cout << "size is ==" << preorder_traversal.size() << endl;
...
void test_delete(Lexicon* lexicon) {
    ...
    // if(lexicon->getRedBlackTree().search("he") != nullptr){
    //     cout << lexicon->getRedBlackTree().search("he")->key << endl;
    // }
...
int main() {
    ...
    // int d;
    // d = findDepth(lexicon->getRedBlackTree().getRoot(), lexicon->getRedBlackTree().getRoot()->right_child->left_child->left_child->key);
    // cout << d << endl;
    ...
    // vector<IndexEntry> ientry = lexicon->buildIndex();
    // HybridNode* temp = lexicon->getRedBlackTree().search("inside");
    // cout << temp->key << endl;
    // cout << temp->ch1 << endl;
    // cout << temp->ch2 << endl;
    // cout << temp->ch3 << endl;
